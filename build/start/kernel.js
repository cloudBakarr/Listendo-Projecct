...
Server_1.default.middleware.register([
    ...
    () => Promise.resolve().then(() => __importStar(global[Symbol.for('ioc.use')]('App/Middleware/BaseUrl')))
]);
Server_1.default.middleware.registerNamed({
    ...
    verified: () => Promise.resolve().then(() => __importStar(global[Symbol.for('ioc.use')]('App/Middleware/CheckEmailVerification')))
});
